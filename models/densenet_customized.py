...
def densenet121(num_class=12, pretrained=None):
    if pretrained is None:
        model = DenseNet(Bottleneck, [6, 12, 24, 16], growth_rate=32, num_class=num_class)
    else:
        model = DenseNet(Bottleneck, [6, 12, 24, 16], growth_rate=32, num_class=100)
